...
import plugin.skill.construction.CrestType;
    ...
    public boolean handle(int interfaceId, int buttonId) {
        switch (stage) {
            ...
            case 300:
                ...
                if (player.getInventory().getAmount(Items.COINS) < 5000) {
                    stage = 302;
                } else {
                    stage = 305;
                }
            ...
            case 320:
                switch (buttonId) {
                    case 1: {
                        ...
                        if (c.eligible(player) && player.getInventory().getAmount(Items.COINS) > c.getCost()
                                && player.getInventory().remove(new Item(Items.COINS, c.getCost()))) {
