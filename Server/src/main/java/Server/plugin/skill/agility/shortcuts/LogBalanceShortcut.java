...
public class LogBalanceShortcut extends AgilityShortcut {
	...
	public Plugin<Object> newInstance(Object arg) {
		...
		configure(new LogBalanceShortcut(new int[] { 3933 }, 50, 1, Location.create(2290, 3232, 0), Location.create(2290, 3239, 0), "cross"));
		configure(new LogBalanceShortcut(new int[] { 3932 }, 50, 1, Location.create(2258, 3250, 0), Location.create(2264, 3250, 0), "cross"));
		configure(new LogBalanceShortcut(new int[] { 3931 }, 50, 1, Location.create(2202, 3237, 0), Location.create(2196, 3237, 0), "cross"));
		return this;
	}
