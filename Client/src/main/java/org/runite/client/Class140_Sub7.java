...
public final class Class140_Sub7 extends GameObject {
    ...
    static boolean method2029(byte var0, CacheIndex var1, int var2) {
        try {
            ...
            throw ClientErrorException.clientError(var4, "uj.B(" + var0 + ',' + (var1 != null ? "{...}" : "null") + ',' + var2 + ')');
        }
    }
    ...
    static boolean method2031(byte var0, boolean var1, int var2, int var3, Class3_Sub2[][][] var4, int var5) {
        try {
            ...
            throw ClientErrorException.clientError(var22, "uj.A(" + var0 + ',' + var1 + ',' + var2 + ',' + var3 + ',' + (var4 != null ? "{...}" : "null") + ',' + var5 + ')');
        }
    }
    ...
    static int method2032(int var0) {
        try {
            ...
            throw ClientErrorException.clientError(var3, "uj.E(" + var0 + ',' + 5439488 + ')');
        }
    }
    ...
    final void animate(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9, int var11, Class127_Sub1 var12) {
        try {
            Model var13 = Class38.getItemDefinition(this.anInt2936).method1110(-1, 0, null, this.anInt2930, 0);
            if (null != var13) {
                var13.animate(var1, var2, var3, var4, var5, var6, var7, var8, var9, var11, var12);
                this.anInt2932 = var13.method1871();
            }
        } catch (RuntimeException var14) {
            throw ClientErrorException.clientError(var14, "uj.IA(" + var1 + ',' + var2 + ',' + var3 + ',' + var4 + ',' + var5 + ',' + var6 + ',' + var7 + ',' + var8 + ',' + var9 + ',' + var11 + ',' + (var12 != null ? "{...}" : "null") + ')');
        }
    }
    ...
    final int method1871() {
        try {
            ...
            throw ClientErrorException.clientError(var2, "uj.MA()");
        }
    }
