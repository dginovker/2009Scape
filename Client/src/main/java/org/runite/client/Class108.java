    ...
    static void method1656(CacheIndex var0, byte var1) {
        try {
            if (!Class140_Sub2.aBoolean2713) {
                ...
                int var2 = GameShell.gameShellAWTHeight;
                int var3 = var2 * 956 / 503;
                Objects.requireNonNull(Class40.aAbstractSprite_680).method639((GameShell.gameShellAWTWidth + -var3) / 2, 0, var3, var2);
                SequenceDefinition.aClass109_1856 = Class3_Sub28_Sub6.a(Class79.anInt1124, var0);
                Objects.requireNonNull(SequenceDefinition.aClass109_1856).method1667(GameShell.gameShellAWTWidth / 2 + -(SequenceDefinition.aClass109_1856.width / 2), 18);
