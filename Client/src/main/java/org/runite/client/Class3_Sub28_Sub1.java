        ...
        try {
            try {
                ...
                if (var2) {
                    ...
                    var5.fillRect(0, 0, GameShell.gameShellAWTWidth, GameShell.gameShellAWTHeight);
                }
                ...
                try {
                    ...
                    var5.drawImage(anImage2695, GameShell.gameShellAWTWidth / 2 - 152, -18 + GameShell.gameShellAWTHeight / 2, null);
                } catch (Exception var9) {
                    int var7 = -152 + GameShell.gameShellAWTWidth / 2;
                    int var8 = -18 + GameShell.gameShellAWTHeight / 2;
                    var5.setColor(var0);
                ...
                if (Class167.aClass94_2083 != null) {
                    var5.setFont(TextCore.Helvetica);
                    var5.setColor(Color.white);
                    Class167.aClass94_2083.drawString(var5, GameShell.gameShellAWTHeight / 2 - 26, GameShell.gameShellAWTWidth / 2 - Class167.aClass94_2083.method1575(aFontMetrics1822) / 2);
                }
