...
final class Class3_Sub28_Sub5 extends Node {
    ...
    Class3_Sub28_Sub5(CacheIndex cacheIndex0, CacheIndex var2, int frame) {
        try {
            ...
            throw ClientErrorException.clientError(var14, "cl.<init>(" + (cacheIndex0 != null ? "{...}" : "null") + ',' + (var2 != null ? "{...}" : "null") + ',' + frame + ',' + false + ')');
        }
    }
...
//	}
    ...
    final boolean method559(int var2) {
        try {
            ...
            throw ClientErrorException.clientError(var4, "cl.D(" + 1317095745 + ',' + var2 + ')');
        }
    }
    ...
    final boolean method561(int var1, byte var2) {
        try {
            ...
            throw ClientErrorException.clientError(var4, "cl.F(" + var1 + ',' + var2 + ')');
        }
    }
